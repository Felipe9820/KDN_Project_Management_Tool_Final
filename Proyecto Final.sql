...
-- Insertar datos en la tabla Year (por ejemplo, para aÃ±os del 2020 al 2025)
...
INSERT ALL
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (1, 'LatinoamÃ©rica')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (2, 'NorteamÃ©rica')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (3, 'Europa')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (4, 'Asia')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (5, 'Ã?frica')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (6, 'OceanÃ­a')
INTO CLUSTERS_GROUPS (ID_CLUSTER, CLUSTER_NAME) VALUES (7, 'SuramÃ©rica')
SELECT * FROM dual;
...
BEGIN
    ...
    VALUES (v_id_cliente, p_NOMBRE, p_STATUS, p_SERVICIO);
...
EXECUTE P_insertar_cliente('Felipe','Activo','Servicio A');
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Cliente con el ID ' || p_id_cliente || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Cliente con el ID ' || p_id_cliente || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el cliente: ' || SQLERRM);
END P_Actualizar_Cliente;

EXECUTE P_Actualizar_Cliente(3, 'Maryann', 'Activo', 'Servicio C');
...
----(Solo actualiza el status del cliente)
...
BEGIN
    UPDATE clients
    SET status_client = p_nuevo_status
    WHERE_id_cliente = id_client;
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('No se encontró un empleado con el ID proporcionado');
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Ocurrió un error al actualizar el status del empleado');
...
---------------------Insertar final status--------------------
CREATE OR REPLACE PROCEDURE INSERTAR_FINAL_STATUS(
p_id_status_final in number,
p_status_name in number

)AS
BEGIN

---------------------Actualizar final status--------------------
----( Actualiza la columna Status_name en la tabla Final_status)
...
as
BEGIN
    -- Actualiza el estado final cambiando el Status_name
    UPDATE FINAL_STATUS
...
END P_Actualizar_Status_Final;
   ...
   EXECUTE P_Actualizar_Status_Final(1, 'ACCEPT');
/
 ---------------------------------------------------------------------
-----------------------Insertar un Country
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Pais registrado correctamente con el ID: ' || v_id_pais);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el Pais: ' || SQLERRM);
...
---------------Eliminar Country----------------\
CREATE OR REPLACE PROCEDURE P_Eliminar_Country(
    p_id_pais IN NUMBER
)
as
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Pais con el ID ' || p_id_pais || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        
        DBMS_OUTPUT.PUT_LINE('Error al borrar el Pais: ' || SQLERRM);
END P_Eliminar_Pais;
...
---------------Actualizar Country----------------
CREATE OR REPLACE PROCEDURE P_Actualizar_Pais (
    p_id_pais IN NUMBER,
...
BEGIN
    ...
    UPDATE countries
    SET   country_name = p_nombre_pais
    WHERE id_country = p_id_pais;

    DBMS_OUTPUT.PUT_LINE('Pais con el  ID ' || p_id_pais || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el Pais: ' || SQLERRM);
END P_Actualizar_Pais;

EXECUTE P_Actualizar_Pais(1, 'espana');


-------------insertar areas-----------
CREATE OR REPLACE PROCEDURE P_Insertar_Area(
    p_Nombre_Area IN VARCHAR2
)
as
    v_id_Area NUMBER;
BEGIN
    ...
    VALUES (v_id_Area, p_Nombre_Area);
--execpciones
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Area con el ID ' || p_id_area || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        
        DBMS_OUTPUT.PUT_LINE('Error al borrar el Area: ' || SQLERRM);
END P_Eliminar_Area;
...
---------------Actualizar Area----------------
CREATE OR REPLACE PROCEDURE P_Actualizar_Area(
    p_id_Area IN NUMBER,
    p_nombre_Area IN VARCHAR2
)
as
BEGIN
    -------- Se actualiza el area deseada -------
    UPDATE AREA
    SET  AREA_NAME  = p_nombre_Area
    WHERE ID_AREA = p_id_Area;

    DBMS_OUTPUT.PUT_LINE('Area con el  ID ' || p_id_Area || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el Area: ' || SQLERRM);
END P_Actualizar_Area;

EXECUTE P_Actualizar_Area(1, 'Business intelligence');
...
--execpciones
    DBMS_OUTPUT.PUT_LINE('El Rol registrado correctamente con ID: ' || v_id_Rol);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el Rol: ' || SQLERRM);
END P_Insertar_Rol;
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        DBMS_OUTPUT.PUT_LINE('Error al borrar el Rol: ' || SQLERRM);
END P_Eliminar_Rol;
...
---------------Actualizar rol----------------
CREATE OR REPLACE PROCEDURE P_Actualizar_Rol(
    p_id_rol IN NUMBER,
    p_nombre_del_rol IN VARCHAR2
)
as
BEGIN
    -------- se actualiza el rol -------
    UPDATE ROLES
    SET  ROLE_NAME  = p_nombre_del_rol
    WHERE ROLE_ID = p_id_rol;

    DBMS_OUTPUT.PUT_LINE('Rol con el  ID ' || p_id_rol || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el Rol: ' || SQLERRM);
END P_Actualizar_Rol;

EXECUTE P_Actualizar_Rol(1, 'IT');

/
/
/
--------------------------insertar Categoria--------------------------
CREATE OR REPLACE PROCEDURE P_insertar_categoria (
    p_nombre_cat IN VARCHAR2
)
as
    v_id_cat NUMBER;
BEGIN
    -- Se le agrega un id segun la insercion
    SELECT NVL(MAX(ID_CATEGORY), 0) + 1 INTO v_id_cat FROM CATEGORY;

    -- Insertar el nuevo cliente en la tabla
    INSERT INTO CATEGORY (ID_CATEGORY,CATEGORY_NAME)
    VALUES (v_id_cat, p_nombre_cat);

    DBMS_OUTPUT.PUT_LINE('Cliente registrado correctamente con ID: ' || v_id_cat);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el cliente: ' || SQLERRM);
END P_insertar_categoria;


EXECUTE P_insertar_categoria ('xxxxx');

/

---------------------eliminar Categoria-----------------
CREATE OR REPLACE PROCEDURE P_eliminar_Categoria(
    p_id_Categoria IN NUMBER
)
as
BEGIN
    -- Borrar el cliente de la tabla
    DELETE FROM CATEGORY WHERE ID_CATEGORY = p_id_Categoria;

    DBMS_OUTPUT.PUT_LINE('La categoria con el ID ' || p_id_Categoria || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al borrar la categoria: ' || SQLERRM);
END P_eliminar_Categoria;

 
EXECUTE P_eliminar_Categoria(2);

/

-----------------Actualizar la categoria-------------------
CREATE OR REPLACE PROCEDURE P_Actualizar_Categoria (
    p_id_Categoria IN NUMBER,
...
BEGIN
    -------- Se actualiza la información del cliente -------
    UPDATE CATEGORY
    SET   CATEGORY_NAME = p_nombre_Categoria
    WHERE ID_CATEGORY = p_id_Categoria;

    DBMS_OUTPUT.PUT_LINE('La categoria con el ID ' || p_id_Categoria || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar la categoria: ' || SQLERRM);
END P_Actualizar_Categoria;

EXECUTE P_Actualizar_Categoria(2, 'zzzzzz');



--------------------------insertar Servicios--------------------------
CREATE OR REPLACE PROCEDURE P_insertar_servicio (
...
BEGIN
    -- Se le agrega un id segun la insercion
    SELECT NVL(MAX(SERVICE_ID), 0) + 1 INTO v_id_servicio FROM SERVICES;

    -- Insertar el nuevo cliente en la tabla
    INSERT INTO SERVICES (SERVICE_ID,SERVICE_NAME)
    VALUES (v_id_servicio, p_nombre_servicio);

    DBMS_OUTPUT.PUT_LINE('servicio registrado correctamente con ID: ' || v_id_servicio);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el servicio: ' || SQLERRM);
END P_insertar_servicio;

EXECUTE P_insertar_servicio ('PAYROLL');

/
/
/
-----------------Actualizar  Servicios-------------------
CREATE OR REPLACE PROCEDURE P_Actualizar_Servicio (
    p_id_Servicio IN NUMBER,
    p_nombre_Servicio IN VARCHAR2
)
as
BEGIN
    -------- Se actualiza la información de Servicios -------
    UPDATE SERVICES
    SET   SERVICE_NAME = p_nombre_Servicio
    WHERE SERVICE_ID = p_id_Servicio;

    DBMS_OUTPUT.PUT_LINE('el servicio con el ID ' || p_id_Servicio || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el servicio: ' || SQLERRM);
END P_Actualizar_Servicio;

EXECUTE P_Actualizar_Servicio(2, 'zzzzzz');



---------------------eliminar Servicios-----------------
CREATE OR REPLACE PROCEDURE P_eliminar_Servicios(
    p_id_Servicios IN NUMBER
)
as
BEGIN
    -- Borrar el Servicio 
    DELETE FROM SERVICES WHERE SERVICE_ID = p_id_Servicios;

    DBMS_OUTPUT.PUT_LINE('El servicio con el ID ' || p_id_Servicios || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al borrar el servicio: ' || SQLERRM);
END P_eliminar_Servicios;

 
EXECUTE P_eliminar_Servicios(1);
...
--------------------------insertar bussines types--------------------------
CREATE OR REPLACE PROCEDURE P_insertar_bt (
    p_nombre_bt IN VARCHAR2
)
as
    v_id_bt NUMBER;
BEGIN
    -- Se le agrega un id segun la insercion
    SELECT NVL(MAX(BUSINESS_TYPE_ID), 0) + 1 INTO v_id_bt FROM BUSINESS_TYPES;

    -- Insertar el nuevo cliente en la tabla
    INSERT INTO BUSINESS_TYPES (BUSINESS_TYPE_ID,BUSINESS_TYPE_NAME)
    VALUES (v_id_bt, p_nombre_bt);

    DBMS_OUTPUT.PUT_LINE('bussines type registrado correctamente con ID: ' || v_id_bt);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el bussines type: ' || SQLERRM);
END P_insertar_bt;

EXECUTE P_insertar_bt ('accounting');

/
/
/
--------------------------insertar bussines types--------------------------
CREATE OR REPLACE PROCEDURE P_Actualizar_bt (
    p_id_bt  IN NUMBER,
    p_nombre_bt  IN VARCHAR2
)
as
BEGIN
    -------- Se actualiza bussines types -------
    UPDATE BUSINESS_TYPES
    SET   BUSINESS_TYPE_NAME = p_nombre_bt
    WHERE BUSINESS_TYPE_ID = p_id_bt;

    DBMS_OUTPUT.PUT_LINE('el bussines type  con el ID ' || p_id_bt || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el bussines type: ' || SQLERRM);
END P_Actualizar_bt;

EXECUTE P_Actualizar_bt(51, 'Human resources');
...
/
/
---------------------eliminar  bussines types-----------------
CREATE OR REPLACE PROCEDURE P_eliminar_bt(
    p_id_bt IN NUMBER
)
as
BEGIN
    -- Borrar el Servicio 
    DELETE FROM BUSINESS_TYPES WHERE BUSINESS_TYPE_ID = p_id_bt;

    DBMS_OUTPUT.PUT_LINE('El bussines type con el ID ' || p_id_bt || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al borrar el bussines type: ' || SQLERRM);
END P_eliminar_bt;

 
EXECUTE P_eliminar_bt(51);
...
/
--------------------------insertar year--------------------------
CREATE OR REPLACE PROCEDURE P_insertar_year (
   v_id_YEAR IN NUMBER
)
as
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('El año registrado correctamente con ID: ' || v_id_YEAR);
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al registrar el año: ' || SQLERRM);
END P_insertar_year;

EXECUTE P_insertar_year (2228);

/
/
/
--------------------------Actualizar YEAR--------------------------
CREATE OR REPLACE PROCEDURE P_Actualizar_YEAR (
    p_id_YEAR  IN NUMBER,
    P_nuevo_year in number
)
as
BEGIN   
    -------- Se actualiza año -------
    UPDATE YEAR
    SET   YEAR_ID = P_nuevo_year
    WHERE YEAR_ID = p_id_YEAR;

    DBMS_OUTPUT.PUT_LINE('el año con el ID ' || p_id_YEAR || ' actualizado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al actualizar el año: ' || SQLERRM);
END P_Actualizar_YEAR;

EXECUTE P_Actualizar_YEAR(2228,2029);
...
/
---------------------eliminar year-----------------
CREATE OR REPLACE PROCEDURE P_eliminar_year(
    p_id_year IN NUMBER
)
as
BEGIN
    -- Borrar el Servicio 
    DELETE FROM YEAR WHERE YEAR_ID = p_id_year;

    DBMS_OUTPUT.PUT_LINE('El bussines type con el ID ' || p_id_year || ' eliminado correctamente.');
EXCEPTION
    WHEN OTHERS THEN
        DBMS_OUTPUT.PUT_LINE('Error al borrar el bussines type: ' || SQLERRM);
END P_eliminar_year;
